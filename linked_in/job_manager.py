...
from linked_in.easy_applier import EasyApplier
...
##
# Job manager is the interface to linkedin that exposes the job application process 
#
# filtering / blacklist companies
# ----- 
# this is reimplemented in jobsearch
# contructing query params that represent parameters of search
# extract information from job view
#
